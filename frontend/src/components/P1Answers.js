...
const P1Answers = (props) => {
  ...
  return (
    <div className="P1Answers">
      ...
      >
        Deforestación, caza de animales y derrumbamiento de tierras por mano del
        hombre
      </button>
      <button
        type="button"
        class="btn btn-success btn-lg btn-block"
        onClick={() => history.push("/P1Doubs")}
      >
      ...
      <button
        ...
        onClick={() => history.push("/*")}
      >
        Oxidación de elementos metálicos, objetos vibratorios y calidad de los
        elementos
      </button>
    </div>
  );
